...
-- Source: audited learning_manage schema snapshot 2026-08-18 (MySQL 8.0.41).
-- This migration creates structure only. It intentionally contains no business/reference data.
-- Existing-database takeover is handled separately by PR 3; do not run this file against a populated database.
