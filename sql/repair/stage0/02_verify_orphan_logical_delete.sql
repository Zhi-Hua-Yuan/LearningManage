-- Verification for the applied Stage 0.2 repair rehearsal.
-- Expected result: all *_failed columns are 0.
...
-- Logical deletion must not change physical row counts.
...
-- Stable automated data-quality rules.
SELECT
