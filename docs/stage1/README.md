...
状态：PR1～PR4 已合并并完成合同收口；PR5 已合并到 `develop`，WP5-A 已完成，WP5-B/C/D 已有 CI 执行证据但正式验收待收口，WP5-E 开发完成且验收待收口，WP5-F 开发中
...
→ PR5 成员退出和移除            merged / final acceptance pending（WP5-A accepted；WP5-B/C/D CI evidence available；WP5-E development completed / acceptance pending；WP5-F development in progress）
→ PR6 周复盘隐私模型            pending
