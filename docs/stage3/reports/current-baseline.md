...
- Promptfoo project contract tests: 19/19 passed.
...
- Full backend regression: 712/712 tests passed against a disposable, Flyway-managed `_ci_`/`_eval` MySQL database.
