...
| `BUG-AUDIT-006` | 合并最新远程 `develop` 并补充审查回归后，后端 CI 和发布门禁固定计数同步更新为 900，静态契约同步更新 | 821 个非 MySQL + 79 个 MySQL 测试；静态契约随完整套件通过 | RESOLVED |
...
| 门禁 | 结果 |
|---|---|
| 非 MySQL 测试 | PASS，821 tests，0 failures，0 errors |
