...
- 真实 `qwen-plus` 在模型协议验证限定范围内 3/3 轮、9/9 场景通过，文本、Tool Call、Tool Result、Usage 与供应商请求 ID 协议均得到验证；该数字不代表业务语义质量评测。
...
- Repository canonical-checkout real-provider report SHA-256：`7288F2C5B81BE2133763A22263EEC66512D6B82A3F901EBD8E1E6F4D4FE5E528`
