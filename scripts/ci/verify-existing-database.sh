...
v8_migrate_output="$(FLYWAY_TARGET_VERSION=8 run_flyway migrate)"
grep -Fq 'migrate.success=true' <<<"$v8_migrate_output" || ci_fail "legacy_v8_migrate_failed"
...
ci_assert_equals "34" "$business_rows_after" "legacy_business_rows_after_unexpected"
...
ci_emit "legacy.migrations_executed" "7"
