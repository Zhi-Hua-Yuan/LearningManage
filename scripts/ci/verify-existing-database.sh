...
user_rows_before="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM \`user\`;")"
team_rows_before="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM team;")"
team_member_rows_before="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM team_member;")"
project_rows_before="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM project;")"
milestone_rows_before="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM milestone;")"
task_rows_before="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM task;")"
weekly_review_rows_before="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM weekly_review;")"
...
task_assignment_log_rows="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM task_assignment_log;")"
weekly_review_task_rows="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM weekly_review_task;")"
canonical_user_rows="$(ci_mysql_migrator --execute="SELECT COUNT(*) FROM \`user\` WHERE user_role IN ('USER', 'SYSTEM_ADMIN');")"
